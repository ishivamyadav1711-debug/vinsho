...
const targetSlug = 'customised-wall-paper-buddha-design';
const targetName = 'Customised Wall Paper — Buddha Design';

console.log('--- Step 1: Remove Customised Wall Paper — Buddha Design from SQLite database ---');
try {
